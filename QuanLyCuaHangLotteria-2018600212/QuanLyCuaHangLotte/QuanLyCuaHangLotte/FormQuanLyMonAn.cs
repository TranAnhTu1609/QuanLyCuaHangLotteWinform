    ...
    public partial class FormQuanLyMonAn : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (spt == null || (spt != null && spt.DonVi != txtLoai.Text))
            {
                if (checkLoiNhapLieu())
                {
                    ...
                    sp.MaLsp = db.LoaiSps.SingleOrDefault(s => s.TenLsp.Equals(cmbLoai.SelectedItem.ToString())).MaLsp;
        ...
        private void dgv_DSSP_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                cmbLoai.Text = db.LoaiSps.SingleOrDefault(s => s.MaLsp.Equals(sp.MaLsp)).TenLsp;
                try
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (checkLoiNhapLieu())
            {
                try
                {
                    ...
                    spSua.MaLsp = db.LoaiSps.SingleOrDefault(s => s.TenLsp.Equals(cmbLoai.SelectedItem.ToString())).MaLsp;
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (checkLoiNhapLieu())
            {
                try
                {
                    ...
                    DialogResult dialog = MessageBox.Show("Bạn có muốn xóa sản phẩm này?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
