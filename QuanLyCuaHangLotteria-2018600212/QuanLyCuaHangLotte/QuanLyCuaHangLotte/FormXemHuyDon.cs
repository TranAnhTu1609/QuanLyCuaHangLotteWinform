...
{
    public partial class FormXemHuyDon : Form
    {
        QuanLyCuaHangLotteContext db = new QuanLyCuaHangLotteContext();
        CultureInfo cul = CultureInfo.GetCultureInfo("vi-VN");
        string TenNv;
        int MaHdk;
        public FormXemHuyDon()
        {
            InitializeComponent();
        }
        public FormXemHuyDon(string TenNv, int Ma)
        {
            InitializeComponent();
            this.TenNv = TenNv;
            MaHdk = Ma;
        ...
        public void exportExcelFile()
        {
            ...
            rowIndex++;
            Microsoft.Office.Interop.Excel.Range huy = worksheet.get_Range("E4", "E4");
            huy.Value2 = "Đã Hủy Đơn";
            huy.Font.Size = 16;
            huy.Font.Bold = true;
            huy.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
            rowIndex++;
        ...
        void ExportPdf(String strPdfPath)
        {
            ...
            prgMdh.Add(new Chunk(lblMahdk.Text+"  (HỦY ĐƠN)", fontBold));
            document.Add(prgMdh);
            #endregion
